...
def manager_create_emp(current_user):
    ...
    try: 
        ...
        new_user = Users(role='employee', email=email,username=username, password=hash_password, created_by=current_user['id'])
...
The Admin Team"""
        ...
        return jsonify({
            ...
            "status": True,
            "role": "employee",
            "message": f"Welcome to Task Management System - Your employee Account"
        }), 200
